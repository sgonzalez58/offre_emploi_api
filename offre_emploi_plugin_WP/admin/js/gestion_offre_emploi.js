...
let tableOffres = jQuery('#liste_offre_en_attente').DataTable({
    ...
    columnDefs:[
        ...
        {targets: 5, render:function (data){                    //création des boutons modifier et supprimer pour chaque ligne
            return "<a href='/wp-admin/admin.php?page=gestion_offre_emploi&id_offre="+ data +"' class='btn btn-success rounded me-2'><i class='fa-regular fa-file-lines'></i></a><button type='button' class='btn btn-danger rounded me-2' data-bs-toggle='modal' data-bs-target='#modalMail' data-bs-offre='"+ data +"'><i class='fa-solid fa-xmark'></i></button>"; 
        }},
